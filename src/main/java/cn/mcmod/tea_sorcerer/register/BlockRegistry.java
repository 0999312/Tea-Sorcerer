...
public class BlockRegistry extends ObjectRegistry {
	...
	public static TileEntityType<TileEntityPlate> PLATE_TE = (TileEntityType<TileEntityPlate>) TileEntityType.Builder.create(TileEntityPlate::new, PLATE).build(null).setRegistryName(Main.MODID, "plate_te");
}
