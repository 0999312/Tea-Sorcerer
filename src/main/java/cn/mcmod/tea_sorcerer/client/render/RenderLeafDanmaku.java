package cn.mcmod.tea_sorcerer.client.render;
...
@OnlyIn(Dist.CLIENT)
public class RenderLeafDanmaku<T extends EntityLeafDanmaku> extends EntityRenderer<T> {
    private static final ResourceLocation TEXTURES = new ResourceLocation(Versions.MODID, "textures/entity/leaf.png");

    public RenderLeafDanmaku(EntityRendererManager p_i46179_1_) {
        super(p_i46179_1_);
    }
    ...
    public void render(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_,
        ...
        p_225623_4_.mulPose(
                Vector3f.ZP.rotationDegrees(MathHelper.lerp(p_225623_3_, p_225623_1_.xRotO, p_225623_1_.xRot)));
        ...
        IVertexBuilder ivertexbuilder = p_225623_5_
                .getBuffer(RenderType.entityCutout(this.getTextureLocation(p_225623_1_)));
