...
@OnlyIn(Dist.CLIENT)
public class TrailParticleNull extends TrailParticle {

    public TrailParticleNull(ClientWorld p_i232351_1_, double p_i232351_2_, double p_i232351_4_, double p_i232351_6_,
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType p_199234_1_, ClientWorld p_199234_2_, double p_199234_3_,
            ...
            TrailParticleNull particle = new TrailParticleNull(p_199234_2_, p_199234_3_, p_199234_5_, p_199234_7_,
