...
public class EffectRegister {
    ...
    public static final RegistryObject<Effect> MAGIC_INCREASE = EFFECTS.register("magic_increase",
            () -> new EffectBlank(EffectType.BENEFICIAL, 0x579943));
    public static final RegistryObject<Effect> IMMOTRAL = EFFECTS.register("immortal",
            () -> new EffectBlank(EffectType.BENEFICIAL, 0x7F0000));
}
