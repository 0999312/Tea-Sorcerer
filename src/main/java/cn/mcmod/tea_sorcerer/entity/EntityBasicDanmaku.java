...
public class EntityBasicDanmaku extends EntityBullet {
    ...
    private static final DataParameter<Integer> DANMAKU_TYPE = EntityDataManager.defineId(EntityBasicDanmaku.class,
            DataSerializers.INT);
    private static final DataParameter<Integer> COLOR = EntityDataManager.defineId(EntityBasicDanmaku.class,
            DataSerializers.INT);
    ...
    public EntityBasicDanmaku(World worldIn, double x, double y, double z, double accelX, double accelY,
            double accelZ) {
